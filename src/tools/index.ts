...
const ALL_TOOL_HANDLERS: Record<string, { handler: (args: any) => Promise<any>; toolName: string }> = {
  "create-chart-using-chartjs": { handler: handleChartTool, toolName: ToolNames.CHART },
  "create-chart-using-apexcharts": { handler: handleApexChartsTool, toolName: ToolNames.APEXCHARTS },
  "create-chart-using-googlecharts": { handler: handleGoogleChartsTool, toolName: ToolNames.GOOGLECHARTS },
  "create-chart-using-natural-language": { handler: handleTextChartTool, toolName: ToolNames.TEXTCHART },
  "create-sparkline-using-chartjs": { handler: handleSparklineTool, toolName: ToolNames.SPARKLINE },
  "create-diagram-using-graphviz": { handler: handleGraphvizTool, toolName: ToolNames.GRAPHVIZ },
  "create-wordcloud": { handler: handleWordCloudTool, toolName: ToolNames.WORDCLOUD },
  ...
  "create-watermark": { handler: handleWatermarkTool, toolName: ToolNames.WATERMARK },
};
